(function(SOP){
	...
	YAHOO.extend(SOP.LoadLabel, Alfresco.component.Base,
	{
		...
		loadLabels : function() {
            ...
            {
               url: Alfresco.constants.PROXY_URI + 'com/sop/picklist/picklist?loadLabels=true&name='+this.options.picklistName+'&itemId='+this.options.itemId+'&initialValues='+this.options.initialValue,
               method: "GET",
